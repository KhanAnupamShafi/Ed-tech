...
const Login = () => {
  const { signInUser, authError, isLoading, handleGoogleSignIn, user } =
    useAuth();
  ...
  return (
    <div>
      <Navbar />
      <section className="font-sans bg-blueGray-50">
            ...
            <div className="flex-auto px-4 lg:px-10 py-10 pt-0">
              ...
              <form onSubmit={handleFormSubmit}>
                ...
                <div className="text-center mt-6">
                  <button
                    className="bg-blue-800 text-white active:bg-blueGray-600 text-lg font-bold uppercase px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 w-full ease-linear transition-all duration-150"
                    type="submit"
                  >
                    {" "}
                    Sign In{" "}
              ...
              {isLoading && (
                <button
                  type="button"
                  className="bg-indigo-500 flex m-auto justify-center"
                  disabled
                >
                  <svg
                    role="status"
              ...
              {user?.email && (
                ...
                >
                  <div class="flex">
                    ...
                    <div>
                      <p class="font-bold">Successfully created User</p>
                      <p class="text-sm">
